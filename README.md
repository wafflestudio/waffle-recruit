...
<<<<<<< HEAD
서울대학교 컴퓨터공학부 소프트웨어 개발 동아리 와플스튜디오에서 23.5기 신입회원 🧇루키, 디자이너🧇, 23기 🧇프로그래머스🧇를 모집합니다!
=======
서울대학교 컴퓨터공학부 소프트웨어 개발 동아리 와플스튜디오에서 23.5기 신입회원 🧇루키, 디자이너🧇를 모집합니다!
>>>>>>> 889963428cd854bb788273c61b74fb7d03e8ecc0
...
## 23기 Programmers 리크루팅 일정

- 지원 기간: 상시 모집
- 지원 방법: recruit@wafflestudio.com으로 아래 정보를 작성하여 메일을 보내주세요.
  - 이름, 힉교, 학과, 학번, 전화번호
  - 슬랙/노션/깃허브 초대를 위한 이메일
  - 지원 포지션 (Frontend, Android/iOS, Server)
  - 주로 사용하는 사용 기술스택
  - 프로젝트 진행과 관련한 자료 및 간략한 소개 (포트폴리오)
- 메일을 보내주시면 7일 이내에 비대면 인터뷰 날짜를 잡아드릴 예정입니다.
